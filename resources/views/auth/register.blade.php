                        ...
                        <div class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                            <div>
                                ...
                                <x-text-input id="name" type="text" name="name" :value="old('name')"
                                    class="bform-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-600 focus:outline-none"
                                    required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="lastname" type="text" name="lastname" :value="old('lastname')"
                                    class="bform-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-600 focus:outline-none"
                                    required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="direction" type="text" name="direction" :value="old('direction')"
                                    class="bform-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-600 focus:outline-none"
                                    required autofocus />
