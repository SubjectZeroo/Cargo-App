<x-guest-layout>
    <div class="h-screen w-full flex flex-shrink-0 justify-center md:items-end overflow-hidden">
        <div class="h-screen w-full flex flex-shrink-0 justify-center md:items-end overflow-hidden">
            ...
            <div class="absolute z-10 self-center flex flex-col items-center">
                <p class="text-gray-300 text-3xl md:text-4xl text-center mx-6 font-bold">Mientras navegas nuestro sitio
                </p>
                ...
                <p class="text-gray-300 text-xl md:text-2xl text-center mx-6 font-thin">Uno de ellos puede ser tuyo en
                    un click.</p>
                <p class="pt-12">
                    <a href="{{ route('register') }}"
                        class="py-4 px-8 rounded-md shadow-xl text-center text-lg font-medium text-white bg-yellow-600 transition transform ease-out duration-500 hover:scale-110 hover:bg-yellow-500 hover:text-gray-100">Registrate</a>
                </p>
            </div>
    ...
    <main class="z-40">
                                ...
                                <div class="-mt-6">
                                    <div>
                                        <span
                                            class="inline-flex items-center justify-center p-2 bg-yellow-600 rounded-md shadow-xl w-16 h-16">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="15 15 70 70"
                                                class="w-8 h-8 text-white" fill="currentColor" stroke="currentColor">
                                                <g>
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="1"
                                                        d="M83,37c0,0,0-0.1,0-0.1c0-0.1,0-0.2,0-0.2c0-0.1,0-0.1,0-0.2c0-0.1,0-0.1-0.1-0.2c0-0.1-0.1-0.1-0.1-0.2c0,0,0-0.1-0.1-0.1   l-8.8-14.1c-1.1-1.8-3-2.8-5.1-2.8H31.2c-2.1,0-4,1.1-5.1,2.8l-8.8,14.1c0,0,0,0.1-0.1,0.1c0,0.1-0.1,0.1-0.1,0.2   c0,0.1,0,0.1-0.1,0.2c0,0.1,0,0.1,0,0.2c0,0.1,0,0.2,0,0.2c0,0,0,0.1,0,0.1v37c0,3.9,3.1,7,7,7h52c3.9,0,7-3.1,7-7V37z M70.5,23.9   L77.4,35H52V23h16.8C69.5,23,70.1,23.4,70.5,23.9z M29.5,23.9c0.4-0.6,1-0.9,1.7-0.9H48v12H22.6L29.5,23.9z M42,77v-7h16v7H42z    M79,74c0,1.7-1.3,3-3,3H62v-9c0-1.1-0.9-2-2-2H40c-1.1,0-2,0.9-2,2v9H24c-1.7,0-3-1.3-3-3V39h58V74z">
                                                    </path>
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="1"
                                                        d="M38.5,55.3c0,1.1,0.9,2,2,2h19c1.1,0,2-0.9,2-2s-0.9-2-2-2h-19C39.4,53.3,38.5,54.2,38.5,55.3z">
                                                    </path>
                                                </g>
                                            </svg>
                                        </span>
                            ...
                            <div class="flow-root bg-gray-50 rounded-2xl px-6 pb-8 shadow-xl h-full">
                                <div class="-mt-6">
                                    <div>
                                        <span
                                            class="inline-flex items-center justify-center p-2 bg-yellow-600 rounded-md shadow-xl w-16 h-16">
                                            <svg viewBox="0 0 65 65" class="w-8 h-8 text-white" fill="currentColor"
                                                stroke="currentColor">
                                                <style type="text/css">
                                                    .st0 {
                                                        display: none;
                                                ...
                                                <g class="st0">
                                                    <g class="st1">
                                                        <rect x="2" y="2" class="st2"
                                                            width="60" height="60"></rect>
                                                        <line class="st2" x1="32" y1="2"
                                                            x2="32" y2="62"></line>
                                                        <line class="st2" x1="62" y1="32"
                                                            x2="2" y2="32"></line>
                                                        <line class="st2" x1="2" y1="2"
                                                            x2="62" y2="62"></line>
                                                        <rect x="10" y="10" class="st2"
                                                            width="44" height="44"></rect>
                                                        <line class="st2" x1="62" y1="2"
                                                            x2="2" y2="62"></line>
                                                        <line class="st2" x1="2" y1="32"
                                                            x2="32" y2="2"></line>
                                                        <line class="st2" x1="32" y1="2"
                                                            x2="62" y2="32"></line>
                                                        <line class="st2" x1="62" y1="32"
                                                            x2="32" y2="62"></line>
                                                        <line class="st2" x1="32" y1="62"
                                                            x2="2" y2="32"></line>
                                                        <circle class="st2" cx="32" cy="32"
                                                            r="21"></circle>
                                                    </g>
                                                </g>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                                                    d="M55.6,42.6L51.8,17H49V7c0-2.8-2.2-5-5-5H14c-2.8,0-5,2.2-5,5v50c0,2.8,2.2,5,5,5h30c2.8,0,5-2.2,5-5V46h3.7  c0.9,0,1.6-0.3,2.2-1C55.5,44.3,55.7,43.5,55.6,42.6z M44,60H14c-1.7,0-3-1.3-3-3v-5h36v5C47,58.7,45.7,60,44,60z M47,50H11V7  c0-1.7,1.3-3,3-3h30c1.7,0,3,1.3,3,3v10h-2c0-3.9-3.1-7-7-7s-7,3.1-7,7h-6.9l-3.8,25.6c-0.1,0.9,0.1,1.8,0.7,2.4s1.4,1,2.3,1H47V50z   M43,17H33c0-2.8,2.2-5,5-5S43,14.2,43,17z M53.6,43.7c-0.2,0.2-0.5,0.3-0.8,0.3H23.4c-0.3,0-0.6-0.1-0.8-0.3  c-0.2-0.2-0.2-0.5-0.2-0.8L25.9,19H31v3h2v-3h10v3h2v-3h5.1l3.7,23.9C53.9,43.2,53.8,43.5,53.6,43.7z">
                                                </path>
                                                <circle stroke-width="4" cx="29" cy="56"
                                                    r="2"></circle>
                                            </svg>
                                        </span>
                                    </div>
                                ...
                                <div class="-mt-6">
                                    <div>
                                        <span
                                            class="inline-flex items-center justify-center p-2 bg-yellow-600 rounded-md shadow-xl w-16 h-16">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="10 10 70 70"
                                                class="w-9 h-9 text-white" fill="currentColor" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                                                    d="M23.942383,33.972778V71c0,4.451172,10.593262,6.780273,21.057617,6.780273S66.057617,75.451172,66.057617,71V33.972778  C68.69397,32.967529,70.393066,31.661316,70.393066,30V19c0-4.974609-15.186035-6.780273-25.393066-6.780273  S19.606934,14.025391,19.606934,19v11C19.606934,31.661316,21.30603,32.967529,23.942383,33.972778z M64.057617,71  c0,1.949219-7.423828,4.780273-19.057617,4.780273S25.942383,72.949219,25.942383,71V34.631714  C31.28717,36.155518,39.00177,36.780273,45,36.780273s13.71283-0.624756,19.057617-2.14856V71z M45,14.219727  c15.358887,0,23.393066,3.111816,23.393066,4.780273S60.358887,23.780273,45,23.780273S21.606934,20.668457,21.606934,19  S29.641113,14.219727,45,14.219727z M21.606934,21.842346C26.062744,24.682617,37.043335,25.780273,45,25.780273  s18.937256-1.097656,23.393066-3.937927V30c0,1.668457-8.03418,4.780273-23.393066,4.780273S21.606934,31.668457,21.606934,30  V21.842346z">
                                                </path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                                                    d="M40.411133,44.266113v5.341309h-5.341797v9.178223h5.341797v5.341309h9.177734v-5.341309h5.341797v-9.178223h-5.341797  v-5.341309H40.411133z M52.930664,51.607422v5.178223h-5.341797v5.341309h-5.177734v-5.341309h-5.341797v-5.178223h5.341797  v-5.341309h5.177734v5.341309H52.930664z">
                                                </path>
                                            </svg>
                                        </span>
                                    </div>
        ...
        <div class="bg-gray-800 py-4">
            <div
                class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-18 lg:px-8 lg:flex lg:items-center lg:justify-between">
                <h2 class="text-3xl font-extrabold tracking-tight text-gray-100 md:text-4xl">
                    ...
                    <span class="block text-yellow-600 text-center lg:text-left">el valor de envío de tus compras
                        online</span>
                </h2>
                <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0 justify-center lg:justify-start">
                    <div class="inline-flex rounded-md shadow-xl">
                        <a href="{{ route('tarifas') }}"
                            class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-500 transition transform ease-out focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-20">
                    <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                        <dl class="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
                            <div>
                                <div
                                    class="flex items-center justify-center h-16 w-16 rounded-md bg-gray-800 text-white mx-auto">
                                ...
                                <div class="mt-5">
                                    ...
                                    <dd class="mt-2 text-base text-center text-gray-600">
                                        Ingresa en tu tienda favorita, selecciona tus productos al carrito y paga tu
                                        compra
                                    </dd>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <dd class="mt-2 text-base text-center text-gray-600">
                                        Nuestro equipo online te acompañará desde antes de efectuar tu compra hasta el
                                        momento en que llegue a tus manos
                                    </dd>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="mt-5">
                                    ...
                                    <dd class="mt-2 text-base text-center text-gray-600">
                                        Llevamos tu carga a tu destino en modalidad de retiro, delivery y encomienda
                                        nacional de manera rápida y segura
                                    </dd>
                                </div>
                            </div>
                        </dl>
                ...
                <div class="mx-auto mt-6 p-4 flex flex-col justify-center items-center space-y-4">
                    ...
                    <div class="shadow-xl transition transform ease-out h-auto mt-4">
                        <a href="{{ route('tarifas') }}"
                            class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-500 transition transform ease-out focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:ring-offset-2">
                            Ver tarifas
                        </a>
                    </div>
                </div>
        ...
        <div id="statsSection" class="statsSection pt-20 pb-12 bg-fixed bg-contain bg-no-repeat bg-center bg-gray-300"
            style="background-image: url(https://images.pexels.com/photos/358319/pexels-photo-358319.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260);box-shadow: inset 0 0 0 1000px rgb(0 0 0 / 80%);">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="max-w-7xl mx-auto">
                            <dl class="rounded-xl bg-gray-800 shadow-xl lg:grid lg:grid-cols-3">
                                <div
                                    class="flex justify-center items-center p-6 text-center border-0 space-x-4 lg:space-x-0 border-r border-gray-600">
                                    <div>
        ...
        <div class="pt-20 pb-12 bg-white">
            <div class="relative sm:py-16">
                <div class="hidden sm:block">
                    <svg class="absolute top-6 left-1/2" width="404" height="392" fill="none"
                        viewBox="0 0 450 450">
                        <defs>
                            <pattern id="8228f071-bcee-4ec8-905a-2a059a2cc4fb" x="0" y="0"
                                width="20" height="20" patternUnits="userSpaceOnUse">
                                <rect x="0" y="0" width="4" height="4"
                                    class="text-gray-500" fill="currentColor"></rect>
                            </pattern>
                        </defs>
                ...
                <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                    <div
                        class="relative rounded-xl px-6 py-10 bg-yellow-600 overflow-hidden shadow-xl sm:px-12 sm:py-20">
                            ...
                            <form action="" class="mt-12 sm:mx-auto sm:max-w-3xl sm:flex">
                                ...
                                <div class="mt-4 sm:mt-0 sm:ml-3">
                                    <input value="Iniciar sesión" type="submit"
                                        class="block w-full rounded-md border border-transparent px-5 py-3 bg-gray-800 text-base font-medium text-white shadow-xl hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-yellow-600 sm:px-10">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                        <div class="lg:self-center">
                            ...
                            <p class="mt-4 text-lg leading-6 text-yellow-600">
                                Descarga nuestro listado de productos frecuentes y conoce el valor estimado de su envío
                                a Venezuela
                            </p>
                            <a href=""
                                class="cursor-pointer mt-8 bg-gray-800 border border-transparent rounded-md shadow-xl px-5 py-3 inline-flex items-center text-base font-medium text-white transition transform ease-out hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 focus:ring-offset-white">
                                Descargar
                            </a>
                        </div>
                    </div>
                    <div>
                        <img src="https://images.pexels.com/photos/4481259/pexels-photo-4481259.jpeg?auto=compress&cs=tinysrgb&w=600"
                            alt="Listado" title="" style="">
                    </div>
                </div>
            </div>
        </div>
