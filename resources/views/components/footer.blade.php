            ...
            <div class="grid grid-col-1 sm:grid-cols-2 gap-8 xl:col-span-4">
                ...
                <div class="mt-4 sm:mt-0 justify-self-end flex flex-col items-center sm:items-end">
                    ...
                    <p class="mt-4 text-base text-gray-300 text-center sm:text-right">
                        Regístrate y obtén tu CARGOID para acceder a beneficios exclusivos.
                    </p>
                    <form class="mt-4 sm:flex sm:max-w-md" action="">
                        ...
                        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                            <button
                                class="w-full bg-yellow-600 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-yellow-500">
                                Registrarte
                            </button>
                        </div>
                    </form>
