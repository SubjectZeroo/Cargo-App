<div class="bg-white w-full">
    <div class="flex justify-between items-center py-4 px-8 md:justify-start">
        ...
        <div class="-mr-2 -my-2 md:hidden justify-self-end">
            <button class="bg-white rounded-md inline-flex items-center justify-center p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-yellow-500">
        ...
        <div class="hidden md:flex-1 md:flex md:items-center md:justify-end">
            <nav class="flex w-full justify-between items-center">
                <a href="" class="hidden sm:flex transition transform ease-in-out duration-200 -ml-2">
                    <span class="sr-only">Cargo App</span>
                    <img class="h-10 w-auto" src="" alt="Cargo App Logo">
                </a>
                <a class="text-base font-medium hover:text-yellow-600 text-center tracking-widest transition transform ease-out  text-yellow-600 " href="">
                    TARIFAS
                </a>
                <a class="text-base font-medium hover:text-yellow-600 text-center tracking-widest transition transform ease-out  text-yellow-600 " href="">
                    SERVICIOS
                ...
                <a class="ml-8 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md text-base font-medium text-white bg-yellow-600 text-center tracking-widest transition transform ease-out shadow-md hover:bg-yellow-500" href="">
                    Registrate
                </a>
            </nav>
        </div>
    ...
    <div id="blackOverlayMobile" class="sm:hidden fixed z-10 inset-0 transition-opacity hidden">
        <div class="absolute z-10 inset-0 bg-gray-500 opacity-75">
        </div>
    </div>
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-yellow-600">
            <div class="pt-5 pb-6 px-5">
                <div class="flex items-center justify-between">
                    <div>
                        <a href="#">
                            <img src="h-10 w-auto transition transform ease-in-out duration-200" alt="Cargo App">
                        </a>
                    </div>
                    <div class="-mr-2">
