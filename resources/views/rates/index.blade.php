                        ...
                        <div class="w-full mx-auto py-2">
                            ...
                            <div class="hidden sm:block">
                                <div class="rounded-xl shadow-md flex wrapper">
                                    <button  data-id="regionCentral"  class="tab-button cursor-pointer text-gray-800 min-w-0 flex-1 rounded-l-xl overflow-hidden py-4 px-4 text-md font-medium text-center bg-white bg-yellow-100 hover:bg-yellow-50 border-b-4 border-yellow-600">
                                        Región central
                                    </button>
                                    <div class="w-0.5 bg-gray-200 "></div>
                                    <button  data-id="regionResto" class="tab-button cursor-pointer text-gray-800 min-w-0 flex-1 rounded-r-xl overflow-hidden py-4 px-4 text-md font-medium text-center bg-white border-b-4 hover:bg-yellow-50">
                                        Resto del país
                                    </button>
                                </div>
