    ...
    <main class="z-40">
            ...
            <div class="relative">
                <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-md mx-auto lg:max-w-5xl space-y-4 lg:space-y-0">
                        <div>
                            <div class="w-full mx-auto py-2">
                                <div class="sm:hidden">
                                    ...
                                    <select name="regionPicker" id="mobileRegionSelector"
                                        class="block w-full focus:ring-yellow-500 focus:border-yellow-500 border-gray-300 rounded-xl bg-yellow-100 p-2 border border-yellow-600">
                                ...
                                <div class="hidden sm:block">
                                    <div class="rounded-xl shadow-md flex wrapper">
                                        <button data-id="regionCentral"
                                            class="tab-button cursor-pointer text-gray-800 min-w-0 flex-1 rounded-l-xl overflow-hidden py-4 px-4 text-md font-medium text-center bg-white bg-yellow-100 hover:bg-yellow-50 border-b-4 border-yellow-600">
                                            Región central
                                        </button>
                                        <div class="w-0.5 bg-gray-200 "></div>
                                        <button data-id="regionResto"
                                            class="tab-button cursor-pointer text-gray-800 min-w-0 flex-1 rounded-r-xl overflow-hidden py-4 px-4 text-md font-medium text-center bg-white border-b-4 hover:bg-yellow-50">
                                            Resto del país
                                        </button>
                                    </div>
                        ...
                        <div id="regionCentral" class="content active">
                            ...
                            <div class="mx-auto space-y-4 max-w-5xl grid gap-5 lg:grid-cols-3 lg:space-y-0">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <svg class="h-6 w-6 text-green-500"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1" d="M5 13l4 4L19 7"></path>
                                                    </svg>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <ul class="space-y-4">
                                            ...
                                            <li class="flex flex-items-start">
                                                ...
                                                <p class="ml-3 text-base text-gray-700">
                                                    Válido para cartas, correspondencia bancaria, tarjetas, documentos,
                                                    protectores de pantallas, tarjetas micro SD, etc
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div id="regionResto" class="content">
                            <div class="w-full py-10">
                                <p class="text-lg font-normal text-white text-center">
                                    Mérida, San Cristobal, Anaco, Barcelona, Maracaibo, Maturín, Puerto Ordaz, Puerto La
                                    Cruz, Punto Fijo, San Juan de los Morros, El Tigre, Ciudad Bolívar, Acarigua,
                                    Guanare, Barinas.
                                </p>
                            </div>
                            <div class="mx-auto space-y-4 max-w-5xl grid gap-5 lg:grid-cols-3 lg:space-y-0">
            ...
            <div class="max-w-7xl mx-auto py-12 px-4 space-y-6 sm:px-6 lg:px-8 flex flex-col items-center">
                ...
                <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div class="inline-flex rounded-md shadow">
                        <a href="#"
                            class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-500 transition transform">
                            Solicitar presupuesto
                            <svg height="682pt" class="h-6 w-6 fill-current text-white ml-2"
                                viewBox="-23 -21 682 682.66669" width="682pt" xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gradient-to-b from-yellow-50 to-gray-100 w-full">
            <div class="max-w-md mx-auto lg:max-w-5xl">
                <div class="p-4 rounded-xl bg-gray-800 shadow-md lg:p-3">
                    <div
                        class="flex items-center justify-between flex-wrap flex-col lg:flex-row space-y-2 lg:space-y-0">
                        <div
                            class="w-full lg:w-0 flex-1 flex items-center flex-col sm:flex-row space-y-2 space-x-0 sm:space-x-2 sm:space-y-0">
                        ...
                        <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto h-full">
                            <a href=""
                                class="flex items-center justify-center px-2 py-2 border border-transparent rounded-md shadow text-sm font-medium text-gray-800 bg-white transition transform hover:bg-gray-100">
        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8 bg-gray-100 py-10">
            <div class="max-w-md mx-auto lg:max-w-5xl flex flex-col space-y-8">
                ...
                <div
                    class="mx-auto w-full lg:space-y-0 flex flex-col justify-evenly space-y-10 lg:space-y-0  space-x-0 lg:space-x-8 lg:inline-flex lg:flex-row pt-12">
                        ...
                        <div class="flow-root bg-white rounded-xl pb-8 shadow-none sm:shadow-lg h-full w-full mx-auto">
                            <div class="-mt-6 space-y-6 px-6 h-full">
                                <div class="w-full inline-flex items-center justify-center">
                                    <span
                                        class="inline-flex items-center justify-center p-3 bg-yellow-600 rounded-md shadow-lg">
                                ...
                                <div
                                    class="grid grid-cols-1 xl:grid-cols-2 grid-rows-2 gap-0 xl:gap-6 xl:py-10 w-full ">
                                    <div class="w-full col-span-1 px-0 xl:px-4">
                                        <p class="block text-base font-light text-gray-700">
                                            Peso (libras)
                                        </p>
                                        <input type="number" name="peso" id="peso" value="1"
                                            class="focus:ring-yellow-500 focus:border-yellow-500 sm:text-base my-2 shadow-md rounded-md bg-gray-100 p-2 w-full calcinput">
                                    </div>
                                    <div class="w-full col-span-1 px-0 xl:px-4">
                                        <p class="block text-base font-light text-gray-700">
                                            Largo (pulgadas)
                                    ...
                                    <div class="w-full col-span-1 px-0 xl:px-4">
                                        ...
                                        <input type="number" name="alto" id="alto" value="1"
                                            class="focus:ring-yellow-500 focus:border-yellow-500 sm:text-base my-2 shadow-md rounded-md bg-gray-100 p-2 w-full calcinput">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flow-root bg-white rounded-xl pb-8 shadow-none sm:shadow-lg h-full w-full mx-auto">
                            <div class="-mt-6 space-y-6 px-6">
                                ...
                                <div class="grid grid-rows-2 grid-cols-2 gap-5 lg:gap-8 w-full h-full">
                                    <div
                                        class="p-6 space-y-4 flex flex-col items-center justify-center w-full bg-gray-100 border-gray-300 rounded-md shadow-md">
                                        <p class="text-base font-light text-gray-700 text-center">
                                            Peso Final
                                        </p>
                                        <div class="flex items-baseline">
                                            <div id="librasCalculadas"
                                                class="text-4xl lg:text-5xl text-gray-700 font-extrabold">
                                                1.00
                                            </div>
                ...
                <div class="mx-auto w-full h-auto pb-6">
                    <p class="text-sm text-gray-500 font-light text-justify">
                        ...
                        Muchas veces el proveedor proporciona las dimensiones del producto y no las dimensiones de la
                        caja en la que embalan el producto, en este sentido, las dimensiones serán tomadas de la caja en
                        la que se encuentran embalados sus productos. No obstante, ponemos a tu disposición un listado
                        de productos frecuentes que nuestra distinguida clientela trae usualmente a través de nuestro
                        servicio aéreo junto con un estimado de su equivalente en libras.
                    </p>
                </div>
            </div>
        </div>
